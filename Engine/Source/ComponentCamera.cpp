...
void ComponentCamera::InitFrustum(math::float3 camPos, math::float3 camFront, math::float3 camUp) 
{
	...
	frustum.up = camUp;
	frustum.nearPlaneDistance = 5.0f; // TODO modify for better rusult
...
void ComponentCamera::InitOrthographicFrustum(math::float3 camPos, math::float3 camFront, math::float3 camUp) 
{
	...
	frustum.front = camFront;
	frustum.up = camUp;
	frustum.nearPlaneDistance = 5.0f; // TODO modify for better results
	frustum.farPlaneDistance = 42000.0f;
...
void ComponentCamera::DrawProperties(bool enabled) 
{
	...
	if (ImGui::CollapsingHeader("Camera properties"))
	{
		...
		ImGui::SliderFloat("zNear", &frustum.nearPlaneDistance, 3.0f, frustum.farPlaneDistance);
